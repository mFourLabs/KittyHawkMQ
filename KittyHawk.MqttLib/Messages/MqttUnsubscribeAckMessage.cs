...
{
    public sealed class MqttUnsubscribeAckMessage : IMqttIdMessage
    {
        private readonly MqttMessageBase _msg;

        internal static MqttUnsubscribeAckMessage InternalDeserialize(byte[] buffer)
        {
            var msg = new MqttUnsubscribeAckMessage();
