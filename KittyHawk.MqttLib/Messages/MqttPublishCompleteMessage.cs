...
{
    public sealed class MqttPublishCompleteMessage : IMqttIdMessage
    {
        private readonly MqttMessageBase _msg;

        internal static MqttPublishCompleteMessage InternalDeserialize(byte[] buffer)
        {
            var msg = new MqttPublishCompleteMessage();
