...
{
    public sealed class MqttPublishReleaseMessage : IMqttIdMessage
    {
        private readonly MqttMessageBase _msg;

        internal static MqttPublishReleaseMessage InternalDeserialize(byte[] buffer)
        {
            var msg = new MqttPublishReleaseMessage();
