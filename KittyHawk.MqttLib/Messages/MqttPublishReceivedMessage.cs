...
{
    public sealed class MqttPublishReceivedMessage : IMqttIdMessage
    {
        private readonly MqttMessageBase _msg;

        internal static MqttPublishReceivedMessage InternalDeserialize(byte[] buffer)
        {
            var msg = new MqttPublishReceivedMessage();
