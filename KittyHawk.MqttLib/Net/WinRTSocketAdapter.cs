...
{
    internal sealed class WinRTSocketAdapter : ISocketAdapter
    {
        ...
        public WinRTSocketAdapter(ILogger logger)
        {
            _logger = logger;
        }
        ...
        {
            await ThreadPool.RunAsync(state => _messageReceivedHandler(new MqttNetEventArgs
            {
                Exception = ex,
